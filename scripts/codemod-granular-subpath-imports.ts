...
const SYMBOL_TARGETS: Record<string, string> = {
  ...
  validateUploadFile: "http/parseMultipartUpload",
  ALLOWED_UPLOAD_MIME_TYPES: "http/uploads",
  DEFAULT_MAX_UPLOAD_BYTES: "http/uploads",
  isAllowedMimeType: "http/uploads",
  resolveMaxUploadBytes: "http/uploads",
