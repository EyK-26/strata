...
|---------|---------|------|
| `@getstrata/core` | 0.5.71 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.58 | HttpKernel, providers, web session helpers |
