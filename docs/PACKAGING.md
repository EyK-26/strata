...
|---------|---------|------|
| `@getstrata/core` | 0.5.72 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.59 | HttpKernel, providers, web session helpers |
