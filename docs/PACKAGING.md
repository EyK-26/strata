...
|---------|---------|------|
| `@getstrata/core` | 0.5.84 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.64 | HttpKernel, providers, web session helpers |
