...
|---------|---------|------|
| `@getstrata/core` | 0.5.68 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.55 | HttpKernel, providers, web session helpers |
