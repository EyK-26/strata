...
|---------|---------|------|
| `@getstrata/core` | 0.5.70 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.57 | HttpKernel, providers, web session helpers |
