...
|---------|---------|------|
| `@getstrata/core` | 0.5.67 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.54 | HttpKernel, providers, web session helpers |
