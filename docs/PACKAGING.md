...
|---------|---------|------|
| `@getstrata/core` | 0.5.90 | Framework runtime and HTTP/database/auth primitives |
| `@getstrata/bootstrap` | 0.2.66 | HttpKernel, providers, web session helpers |
