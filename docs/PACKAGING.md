...
3. Tag a release: `git tag v0.7.6 && git push origin v0.7.6`.
...
5. To finish GHCR or GitHub Release notes after a tag without retagging: Actions, Release, Run workflow, set `tag` to the existing tag (example `v0.7.6`). That path skips npm.
